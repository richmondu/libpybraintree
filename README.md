...
libpybraintree demonstrates usage of Braintree's Python SDK for processing online payments including payment using Paypal.
...
-  1 for the prorated current month
   same plan but with discount
   used discounts to subtract the prorated_amount = plan_amt - plan_amt*(total_days-remaining_days)/total_days
